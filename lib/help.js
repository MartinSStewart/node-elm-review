...
You can customize the review command with the following flags:
    ...
    ${chalk.cyan('--template <author>/<repo>[path-to-the-config-folder][#branch-or-commit]')}
        ...
        Examples:
          - elm-review --template author/review-configuration
          - elm-review --template jfmengels/review-unused/example#master
...
function newRule() {
  /* eslint-disable prettier/prettier */
  console.log(`The new-rule command adds an empty rule to your review
